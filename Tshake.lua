...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1797771210,1768678878}
print("\27[34m"..[[
...
sendtext(chat,msg.id_," 𖠪 ملف النسخه الاحتياطيه ليس لهاذا البوت")   
return false 
end      
...
sendtext(chat,msg.id_,"* 𖠪 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")   
end      
...
send(chat,msg.id_," 𖠪 تم رفع الملف بنجاح وتفعيل المجموعات\n 𖠪 ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")   
end

function Is_Not_Spam(msg,type)
if type == "kick" then 
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪 قام بالتكرار هنا وتم طرده")  
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪 قام بالتكرار هنا وتم تقييده")  
return false  
end  
if type == "mute" then
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪 قام بالتكرار هنا وتم كتمه")  
database:sadd(bot_id.."Tshake:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
send(msg.chat_id_, msg.id_,"𖠪تم الغاء الاذاعه") 
...
send(msg.chat_id_, msg.id_,"𖠪تمت الاذاعه الى *~ "..#list.." ~* مجموعه ")     
database:del(bot_id.."Tshake:Tshake:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪  تم منع الملصق هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪  تم منع الصوره هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪  تم منع المتحركه هنا")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
send(msg.chat_id_, msg.id_,"𖠪عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"𖠪ليس لدي صلاحية تغيير معلومات المجموعه يرجى المحاوله لاحقا") 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,"𖠪تم تغيير صورة المجموعه") 
end
end, nil) 
database:del(bot_id.."Tshake:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,"𖠪تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"𖠪تم الغاء الاذاعه للخاص") 
...
send(msg.chat_id_, msg.id_,"𖠪تمت الاذاعه الى *~ "..#list.." ~* مشترك في الخاص ")     
database:del(bot_id.."Tshake:Tshake:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
if Tshake_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖠪 "..Tshake_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل الدردشه")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل اضافة الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل دخول الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل البوتات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lockkick","𖠪️تم قفـل البوتات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل الاشعارات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل التثبيت هنا")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل تعديل")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","𖠪️تم قفـل جميع الاوامر")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فتح اضافة الاعضاء")  
return false
end 
if text == "فتح الدردشه" and msg.reply_to_message_id_ == 0 and Owner(msg) then 
database:del(bot_id.."Tshake:Lock:text"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فتح الدردشه")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فتح دخول الاعضاء")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فـتح البوتات")  
return false
end 
if text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:del(bot_id.."Tshake:Lock:Bot:kick"..msg.chat_id_)  
...
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فـتح الاشعارات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فـتح التثبيت هنا")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"unlock","𖠪️تم فـتح تعديل")  
return false
end 
...
send(msg.chat_id_, msg.id_, "𖠪لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "𖠪لا تسطيع حظر البوت عام")
return false 
end
database:sadd(bot_id.."Tshake:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم حظره عام من المجموعات")  
end
...
send(msg.chat_id_,msg.id_,"𖠪عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end      
...
Reply_Status(msg,result.id_,"reply","𖠪تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم حظره عام من المجموعات")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
function Function_Tshake(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","𖠪تم الغاء حظره عام من المجموعات")  
...
Reply_Status(msg,userid,"reply","𖠪تم الغاء حظره عام من المجموعات")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته مطور في البوت")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم ترقيته مطور في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم تنزيله من المطورين")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم تنزيله من المطورين")  
return false 
end
if text == ("تنزيل مالك") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBot(msg) then 

local res = https.request('https://textchuser.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تنزيله من المالك")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته مالك")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته مالك")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته منشئ اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته منشئ اساسي")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم ترقيته منشئ اساسي")  
return false
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,userid,"reply","𖠪تم تنزيله من المنشئين")  
return false
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته منشئ في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته منشئ في المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم ترقيته منشئ في المجموعه")  
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته مدير المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end  
...
send(msg.chat_id_, msg.id_," 𖠪 تم ازالة 100 من وسائط ") 
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته مدير المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم ترقيته مدير المجموعه")  
return false
end  
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تنزيله من المدراء")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end  
...
Reply_Status(msg,result.id_,"reply","𖠪تم تنزيله من المدراء")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم تنزيله من المدراء")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته ادمن للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته ادمن للمجموعه")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم ترقيته ادمن للمجموعه")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم تنزيله من ادمنيه المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم تنزيله من ادمنيه المجموعه")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم ترقيته مميز للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم ترقيته مميز للمجموعه")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم ترقيته مميز للمجموعه")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تنزيله من المميزين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم تنزيله من المميزين")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم تنزيله من المميزين")  
return false
end  
...
send(msg.chat_id_, msg.id_,"\n𖠪العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n 𖠪 تم رفعه "..RTPA.." هنا\n")   
...
if Tshakert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n𖠪العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n 𖠪 تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Tshake:Special:User"..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'𖠪لقد تم تعطيل الحظر و الطرد من قبل المنشئين')
return false
end
function Function_Tshake(extra, result, success)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n𖠪عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(result.sender_user_id_,msg.chat_id_).." )")
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"𖠪ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم حظره من المجموعه")  
end,nil)   
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
...
send(msg.chat_id_, msg.id_, "\n𖠪عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(result.id_,msg.chat_id_).." )")
else
...
Reply_Status(msg,result.id_,"reply","𖠪تم حظره من المجموعه")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_, "𖠪لا يوجد حساب بهاذا المعرف")
...
send(msg.chat_id_, msg.id_, "\n𖠪عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(userid,msg.chat_id_).." )")
else
...
Reply_Status(msg,userid,"reply","𖠪تم حظره من المجموعه")  
end,nil)   
end
return false
end
...
function Function_Tshake(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, " 𖠪 انا لست محظورا \n") 
return false 
end
database:srem(bot_id.."Tshake:Ban:User"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم الغاء حظره من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم الغاء حظره من هنا")  
else
send(msg.chat_id_, msg.id_, "𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم الغاء حظره من هنا")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم كتمه من هنا")  
else
send(msg.chat_id_, msg.id_, "𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم كتمه من هنا")  
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم الغاء كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم الغاء كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم الغاء كتمه من هنا")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم تقييده في المجموعه")  
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
...
Reply_Status(msg,result.id_,"reply","𖠪تم تقييده في المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم تقييده في المجموعه")  
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم الغاء تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","𖠪تم الغاء تقييده")  
else
send(msg.chat_id_, msg.id_, "𖠪لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖠪تم الغاء تقييده")  
return false
end
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","𖠪تم طرده من هنا")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
...
Kick_Group(msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","𖠪تم طرده من هنا")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_, "𖠪لا يوجد حساب بهاذا المعرف")
...
Kick_Group(msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","𖠪تم طرده من هنا")  
end,nil)   
end
return false
end
...
send(msg.chat_id_,msg.id_," 𖠪 التثبيت والغاء التثبيت تم قفله من قبل المنشئين")  
return false  
end
...
send(msg.chat_id_,msg.id_,"𖠪انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"𖠪ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖠪تم الغاء تثبيت الرساله")   
...
send(msg.chat_id_,msg.id_," 𖠪 ارسل رابط المجموعه او رابط قناة المجموعه")
...
send(msg.chat_id_, msg.id_,"𖠪تم تفعيل جلب الرابط المجموعه") 
return false  
end
end
...
if link then                              
send(msg.chat_id_,msg.id_," 𖠪 رابط المجموعة ~\n ["..link.."]")                          
else                
send(msg.chat_id_, msg.id_,"𖠪لا يوجد رابط ارسل ضع رابط")              
end            
end
...
Welcome = " 𖠪 لم يتم تعيين ترحيب للمجموعه"
end 
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"𖠪ارسل التحذير عند ارسال الكلمه")  
...
send(msg.chat_id_, msg.id_,"𖠪تم الغاء منعها ")  
database:del(bot_id.."Tshake:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
if #admins == i then 
local a = "\n𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪 \n𖠪عدد البوتات التي هنا >> {"..n.."} بوت\n"
local f = " 𖠪 عدد البوتات التي هي ادمن >> {"..t.."}\n𖠪ملاحضه علامة ال (✯) تعني ان البوت ادمن \n💥"
...
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "𖠪تم الغاء حفظ القوانين") 
...
send(msg.chat_id_, msg.id_,"𖠪تم حفظ قوانين المجموعه") 
database:del(bot_id.."Tshake:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Addictive(msg) then
send(msg.chat_id_, msg.id_," 𖠪 تم ازالة قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_,"𖠪لا توجد قوانين هنا")   
end    
end
...
send(msg.chat_id_, msg.id_," 𖠪 ارسل الامر الذي قم بوضعه بدلا عن القديم")  
return false
end
end
...
send(msg.chat_id_, msg.id_," 𖠪 تم مسح الصلاحيات")
end
...
send(msg.chat_id_, msg.id_,"𖠪ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Tshake:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"𖠪ارسل الكلمه التري تريد حذفها")
...
send(msg.chat_id_, msg.id_, ' 𖠪 الان ارسل الرد الذي تريد اضافته \n 𖠪  قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
...
first_name = "𖠪اسمك الاول ← {`"..(result.first_name_).."`}"
else
first_name = ""
end   
...
local taha = "𖠪 عدد الادمنيه : "..data.administrator_count_..
...
send(msg.chat_id_, msg.id_,"𖠪 عذرا لا استطيع طرد ادمنية المجموعه") 
return false  
end
...
database:srem(bot_id.."Tshake:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."Tshake:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n𖠪 العضو » ["..result.title_.."](t.me/"..(username or "kenwa")..")"
status  = "\n𖠪تم الغاء القيود عنه"
...
database:srem(bot_id.."Tshake:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n𖠪 العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "kenwa")..")"
status  = "\n𖠪تم الغاء القيود عنه"
...
send(msg.chat_id_, msg.id_,"𖠪الحظر العام » "..GBan.."\n𖠪الحظر » "..Ban.."\n𖠪 الكتم » "..Muted)
else
send(msg.chat_id_, msg.id_,"𖠪المعرف غلط")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Tshake, nil)
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖠪  ليست لدي صلاحية تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_," 𖠪  تم تغيير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖠪  تمت ترقية { "..num2.." } من ادمنية المجموعه") 
end
end,nil)   
end
if text ==("المنشئ") then
...
local UserName = (b.username_ or "DDDDiD")
send(msg.chat_id_, msg.id_," 𖠪 تم ترقية منشئ المجموعه ~ ["..b.first_name_.."](T.me/"..UserName..")")  
...
send(msg.chat_id_, msg.id_,"𖠪تم مغادرة المجموعه") 
...
send(msg.chat_id_, msg.id_,"𖠪تم مغادرة المجموعه") 
send(GP_ID[2], 0,"𖠪تم مغادرة المجموعه بامر من مطور البوت") 
...
send(msg.chat_id_, msg.id_,"𖠪ارسل لي الاسم الان ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,"𖠪 تم الغاء الحظر عن *~ "..num.." ~* اشخاص ") 
end    
...
send(msg.chat_id_, msg.id_,"𖠪الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."Tshake:Tshake:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖠪 ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n𖠪للخروج ارسل الغاء ") 
return false
end 
...
https.request('https://devstorm.ml/textchusers.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"𖠪تم الغاء تعين الايدي") 
...
if Number > 1000 then 
send(msg.chat_id_, msg.id_,'𖠪لا تستطيع تنضيف اكثر من *~ 1000* رساله') 
return false  
end  
local Message = msg.id_
...
send(msg.chat_id_, msg.id_,' 𖠪 تم تنظيف *~ '..Number..'* رساله .')  
end
...
send(msg.chat_id_, msg.id_,'* 𖠪 ايديه - '..Id..'\n𖠪رسائله - '..NumMsg..'\n📌معرفه - *['..UserName_User..']*\n 𖠪 تفاعله - '..TotalMsg..'\n 𖠪 رتبته - '..Status_Gps..'\n⚡تعديلاته - '..message_edit..'\n💠جهاته - '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
...
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗"," 𖠪 ","📅","📪","𖠪"," 𖠪 ","📭","⏰","📺","🎚","☎️"," 🦅 "}
SM = Random[math.random(#Random)]
database:set(bot_id.."Tshak:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يدز معنى السمايل ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يدز العكس ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"\n 𖠪 اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."𖠪ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".." 𖠪 سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
𖠪اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
...
name = string.gsub(name,"👨‍🔬","👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬👨‍🔬👩‍🔬👩‍🔬👩‍🔬")
name = string.gsub(name,"👨‍💻","👩‍💻👩‍💻👩‍‍💻👩‍‍💻👩‍💻👨‍💻👩‍💻👩‍💻👩‍💻")
name = string.gsub(name,"👨‍ 𖠪 ","👩‍ 𖠪 👩‍ 𖠪 👩‍ 𖠪 👩‍ 𖠪 👩‍ 𖠪 👩‍ 𖠪 👨‍ 𖠪 👩‍ 𖠪 ")
name = string.gsub(name,"👩‍🍳","👨‍🍳👨‍🍳👨‍🍳👨‍🍳👨‍🍳👩‍🍳👨‍🍳👨‍🍳👨‍🍳")
name = string.gsub(name,"🧚‍♀","🧚‍♂🧚‍♂🧚‍♂🧚‍♂🧚‍♀🧚‍♂🧚‍♂")
name = string.gsub(name,"🧜‍♂","🧜‍♀🧜‍♀🧜‍♀🧜‍♀🧜‍♀🧚‍♂🧜‍♀🧜‍♀🧜‍♀")
name = string.gsub(name,"🧝‍♂","🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♂🧝‍♀🧝‍♀🧝‍♀")
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_," 𖠪 اسرع واحد يدز الاختلاف ~ {"..name.."}")
return false
end
end
...
local Text = '𖠪عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
...
local Text = '𖠪عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
...
if Num == 0 then 
Text = "𖠪لم تلعب اي لعبه للحصول على جواهر"
else
Text = "𖠪عدد جواهر التي رحبتها هي *~ { "..Num.." } مجوهره *"
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, "𖠪تم الغاء الامر ") 
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'𖠪لا يوجد مشتركين وهميين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*𖠪عدد المشتركين الان ~ '..#pv..'\n𖠪تم العثور على ~ '..sendok..' مشترك قام بحظر البوت\n☑اصبح عدد المشتركين الان ~ '..ok..' مشترك *')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖠪لا توجد مجموعات وهميه ')   
else
local taha = (w + q)
...
taha = '\n𖠪 تم ازالة ~ '..q..' مجموعات من البوت'
end
if w == 0 then
storm = ''
else
storm = '\n𖠪 تم ازالة ~'..w..' مجموعه لان البوت عضو'
end
...
download_to_file('https://raw.githubusercontent.com/Bandaa2/Sooon/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/Bandaa2/Sooon/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
send(msg.chat_id_, msg.id_,'𖠪 تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
...
send(msg.chat_id_, msg.id_,' 𖠪 احصائيات البوت \n\n𖠪عدد المجموعات *~ '..Groups..'\n𖠪عدد المشتركين ~ '..Users..'*')
end
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./File_Libs/'..bot_id..'.json', '𖠪 عدد مجموعات التي في البوت { '..#list..'}')
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/Sooon/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖠪 اهلا بك في متجر ملفات تشاكيx \n𖠪الملفات الموجوده حاليا \nꔹ𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪ꔹ\n\n"
...
if file_bot then
io.close(file_bot)
t = "* 𖠪  الملف » {"..file.."}\n 𖠪  تم تعطيله وحذفه بنجاح \n✓*"
else
t = "* 𖠪  بالتاكيد تم تعطيل وحذف ملف » {"..file.."} \n✓*"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/Sooon/master/files_tshake/"..file)
if res == 200 then
os.execute("rm -fr Tshake_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DDDDiD.lua')  
else
send(msg.chat_id_, msg.id_,"*𖠪 عذرا لا يوجد هاكذا ملف في المتجر *\n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = "* 𖠪  بالتاكيد تم تنزيل وتفعيل ملف » {"..file.."} \n✓*"
else
t = "* 𖠪  الملف » {"..file.."}\n 𖠪  تم تنزيله وتفعيله بنجاح \n💥*"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/Sooon/master/files_tshake/"..file)
if res == 200 then
...
send(msg.chat_id_, msg.id_,'𖠪تم نقل : '..#Groups..' كروب\n𖠪تم نقل : '..#Users..' مشترك \n 𖠪 من التحديث القديم الى التحديث الجديد')
end
...
send(msg.chat_id_,msg.id_,'𖠪ارسل الكليشه الان')
return false
end
...
𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪
𖠪قفل/فتح + الاوامر الادناه 
𖠪قفل/فتح + الامر بالتقيد • بالطرد • بالكتم
𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪
 𖠪 الروابط
 𖠪 المعرف
 𖠪 التاك
...
𖠪تفعيل/تعطيل الايدي بالصوره
𖠪تفعيل/تعطيل الايدي
𖠪تفعيل/تعطيل ردود المطور
𖠪تفعيل/تعطيل اللعبه/الالعاب
𖠪تفعيل/تعطيل ردود المدير
𖠪تفعيل/تعطيل اطردني
𖠪تفعيل/تعطيل الرفع
𖠪تفعيل/تعطيل الحظر/الطرد
𖠪تفعيل/تعطيل الرابط/جلب الرابط
𖠪تفعيل/تعطيل اوامر التحشيش
...
𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪
 ...
 𖠪 اضف/حذف امر
 𖠪 الاوامر المضافه
 𖠪 حذف/مسح الاوامر المضافه
 𖠪 اضف رسائل + العدد بالرد
 𖠪 اضف مجوهرات + العدد بالرد
𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪
 🦅 CH [@textchuser]
]]
send(msg.chat_id_, msg.id_,Text)
...
𖠪═───═𝗦𝗢𝗢𝗡═───═𖠪
 ...
 𖠪 مسح ردود المطور
 𖠪 ردود المطور 
 𖠪 وضع /حذف كليشه المطور 

 𖠪 تحديث  + تحديث السورس 

 𖠪 تفعيل/تعطيل البوت الخدمي 
 𖠪  تعين عدد الاعضاء + العدد
 𖠪 تفعيل/تعطيل المغادرة
 𖠪 تفعيل/تعطيل الاذاعه 
 𖠪 تفعيل/تعطيل ملف + اسم الملف
 𖠪 الملفات 
 𖠪 مسح جميع الملفات 
 𖠪 المتجر 
 𖠪 اوامر المطور 
...
send(msg.chat_id_, msg.id_,'𖠪عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Tshake:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
Text = ' 𖠪 تم تفعيل مجموعه جديده\n'..
'\n𖠪بواسطة ~ '..Name..''..
'\n 𖠪 ايدي المجموعه ~ `'..IdChat..'`'..
'\n𖠪عدد اعضاء المجموعه *~ '..NumMember..'*'..
...
send(msg.chat_id_, msg.id_,'𖠪المجموعه معطله سابقا ')
else
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'𖠪البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if database:sismember(bot_id..'Tshake:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'𖠪المجموعه مفعله سابقا ')
else
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Tshake:Num:Add:Bot') or 0) and not DevTshake(msg) then
send(msg.chat_id_, msg.id_,'𖠪عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Tshake:Num:Add:Bot') or 0)..'* عضو')
return false
...
'\n𖠪بواسطة ~ '..Name..''..
'\n𖠪موقعه في المجموعه ~ '..AddPy..'' ..
'\n𖠪ايدي المجموعه ~ `'..IdChat..'`'..
'\n𖠪عدد اعضاء المجموعه *~ '..NumMember..'*'..
'\n 𖠪 اسم المجموعه ~ ['..NameChat..']'..
'\n 𖠪 الرابط ~ ['..LinkGp..']'
if not DevTshake(msg) then
...
if text == '/start' then  
if DevTshake(msg) then
local Text = ' 𖠪 مرحبا بك في اوامر المطور الجاهزه'
local keyboard = {
{'الاحصائيات'},
...
Test = ' 𖠪 مرحبا انا بوت حماية كروبات\n 𖠪 وضيفتي حماية المجموعات من السبام والتفليش والخ...\n☑لتفعيل البوت اضفني الى مجموعاتك قم برفعي مشرف ثم ارسل تفعيل \n☑معرف المطور ['..UserName..']'
end 
send(msg.chat_id_, msg.id_, Test) 
end
end
...
send(msg.sender_user_id_,msg.id_,' 𖠪 تمت ارسال رسالتك الى ~ ['..UserName..']')    
...
sendText(Id_Sudo,'𖠪تم ارسال الملصق من ~ ['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')',0,'md') 
return false
...
if text == 'حظر' then
sendText(Id_Sudo,'𖠪 لشخص » ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n𖠪 تم حظره من التواصل ',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'BaN:In:User',data.id_)  
return false  
end 
if text =='الغاء الحظر' then
sendText(Id_Sudo,'𖠪الشخص » ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n𖠪 تم الغاء حظره من التواصل ',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,'*𖠪 عدد المجموعات الان ~ '..#group..' مجموعه '..storm..''..taha..'\n 𖠪 اصبح عدد المجموعات الان ~ '..sendok..' مجموعات*\n')   
end
end
end,nil)
end
...
database:del(bot_id..'Tshake:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'\n𖠪تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' then
database:set(bot_id..'Tshake:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'\n𖠪تم تعطيل البوت الخدمي') 
end
...
database:set(bot_id.."Tshake:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, " 𖠪 تم تعطيل مغادرة البوت") 
return false 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' then   
send(msg.chat_id_, msg.id_," 𖠪 تم الغاء حفظ كليشه ستارت") 
...
{
{text = ' اوامر المنشئين', callback_data=data.sender_user_id_.."/help4"},
},
{
...
send(msg.chat_id_, msg.id_," 𖠪 تم ازالة الامر من المجموعه")  
else
send(msg.chat_id_, msg.id_," 𖠪 لا يوجد امر بهاذا الاسم تاكد من الامر واعد المحاوله")  
end
...
Reply_Status(result,result.sender_user_id_,"reply"," 𖠪 قام بالتعديل على الميديا")  
...
if Tshake_Msg then    
Reply_Status(result,result.sender_user_id_,"reply"," 𖠪 "..Tshake_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
